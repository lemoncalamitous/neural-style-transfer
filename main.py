...
def parse_args():
    ...
    parser.add_argument('--content', type=str, default='content/raymond.jpg', help='File path of content image (notation in the paper : p)', required = True)
    parser.add_argument('--style', type=str, default='style/starry-night.jpg', help='File path of style image (notation in the paper : a)', required = True)
